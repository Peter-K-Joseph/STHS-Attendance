        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="./view_attendance.php">View Individual Attendance</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#">View All Attendance</a>
                    </li>
                </ul>
            </div>
        </div>
...
<label class="form-check-label" for="subject_' . $i . '">' . $_SESSION["subject"][$i] . '</label>
        ...
        <div class="card">
            ...
            <div class="card-body" id="tableData">
                <h3 class="text-center">Search by Class and Subject to continue</h3>
            </div>
        </div>
</body>
<script src="./overview_attendance.js"></script>
